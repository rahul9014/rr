...
def autostart():
    ...
    SCRIPT_DIR = os.path.join(USER_APPDATA, r"Microsoft\Windows\Start Menu\Programs")
    ...
    def copy_self_to_appdata():
        ...
        print(f" Copied script to AppData: {TARGET_SCRIPT}")
...
"""
    ...
    # Copy itself to AppData\Programs if not exists
    if not os.path.exists(TARGET_SCRIPT):
        copy_self_to_appdata()

    # Create .bat in Startup folder only if not exists
